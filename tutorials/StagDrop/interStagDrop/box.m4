...
//*******************************************************************************
m4_define(xLength, 0.025) // the width of straight Channel
m4_define(yLength, 0.025) // the width of straight Channel
m4_define(zLength, 0.025) // the height of straight Channel

//mesh
m4_define(Nmesh, 40) //number of radial mesh
