function [v, f, n, c, stltitle] = stlread(filename)
% This function reads an STL file in binary format into vertex and face
% matrices v and f.
%
% USAGE: [v, f, n, c, stltitle] = stlread(filename);
%
%
...
%   [v, f]=patchslim(v, f);
%
% Loosely Based on code originally written by:
%    Doron Harlev
% 
