...
//*******************************************************************************
m4_define(xLength, 1) // the width of straight Channel
m4_define(yLength, 1) // the width of straight Channel
m4_define(zLength, 2) // the height of straight Channel

//mesh
m4_define(NmeshX, 64) //number of radial mesh
m4_define(NmeshY, 64) //number of radial mesh
m4_define(NmeshZ, 128) //number of radial mesh
