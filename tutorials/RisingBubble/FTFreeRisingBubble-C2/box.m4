...
//*******************************************************************************
m4_define(xLength, 0.2088) // the width of straight Channel
m4_define(yLength, 0.2088) // the width of straight Channel
m4_define(zLength, 0.3654) // the height of straight Channel

//mesh
m4_define(NmeshX, 40) //number of radial mesh
m4_define(NmeshY, 40) //number of radial mesh
m4_define(NmeshZ, 70) //number of radial mesh
